...
const media = '/media/';
const whatsappUrl = 'https://wa.me/?text=Hello%20The%20Royal%20Trim%2C%20I%27d%20like%20to%20book%20an%20appointment.';
const services = [
...
function App() {
  ...
  return <div className="site-shell" ref={app}>
    ...
    <footer><a className="wordmark" href="#top"><BrandMark compact /><span>THE ROYAL TRIM</span></a><p>Premium men&apos;s grooming, Rawalpindi.</p><div><button type="button" onClick={openMenu}>Full menu</button><a href={whatsappUrl} target="_blank" rel="noreferrer">WhatsApp</a><a href="#gallery">Instagram</a></div></footer><a className="whatsapp-float" href={whatsappUrl} target="_blank" rel="noreferrer" aria-label="Chat with The Royal Trim on WhatsApp"><span>◌</span><b>Chat with us</b></a>{bookingOpen && <BookingModal service={bookingService} onClose={() => setBookingOpen(false)} />}
  </div>;
}
